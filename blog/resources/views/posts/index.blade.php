        ...
        <div class="row justify-content-between">
            ...
            <div class="col-12 col-md-4">
                <div class="float-lg-end">
                    ...
                    <a href="{{route("posts.create")}}" role="button" class="btn btn-sm btn-success mb-1"><i class="fas fa-plus-circle"></i>
                        Create post</a>

                    <a href="{{route("categories.create")}}" role="button" class="btn btn-sm btn-success mb-1"><i class="fas fa-plus-circle"></i>
                        Create category</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="small mb-0">
                                        <span class="me-2">
                                            ...
                                            {{-- TODO: Author --}}
                                            <span>By {{ $post->author ? $post->author->name : 'Anonymus' }}</span>
                                        </span>
